...
public class Engine {
	...
	public void readPopulation() throws IOException {
		...
		for(int i = 0; i < pfcIterations && seguir == true; i++) { // Loop to increment or decrement preferences	
			...
			//System.out.println("Preferences ANTES de incrementar: ");
		    //this.fitness.printMPreferences();
			...
			if(this.fitness.distributionVariationPositive() == false || this.fitness.distributionVariationNegative() == false)
				seguir = false;
			else
				seguir = true;

			//System.out.println("Preferences DESPUES de decrementar: ");
			//this.fitness.printMPreferences();	
		}
