...
public class Engine {
	private final int avgIterations = 5; // Average Iterations
	private final int generations = 30000; // Evolutions of population
	private final int popSize = 50; // Population Size
